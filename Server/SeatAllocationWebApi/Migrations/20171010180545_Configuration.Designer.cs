...
namespace SeatAllocationWebApi.Migrations
{
    ...
    [Migration("20171010180545_Configuration")]
            ...
            modelBuilder.Entity("SeatAllocationWebApi.Model.Request", b =>
                {
                    ...
                    b.HasOne("SeatAllocationWebApi.Model.ApprovingAuthority", "ApprovingAuthorities")
                        .WithMany()
                        .HasForeignKey("EmpCode");

                    b.HasOne("SeatAllocationWebApi.Model.LocationStructure", "LocationStructures")
                        .WithMany()
                        .HasForeignKey("LocationCode")
                        .OnDelete(DeleteBehavior.Cascade);
                });
